...
const Home = () => {
  const [data, setData] = useState([
    {
      ...
      comments: [
        ...
        { author: "فاطمة الزهراء", text: "أنا أواجه نفس المشكلة مع طفلي، هذا مفيد جداً." },
      ],
    },
    {
      id: 2,
  ...
  return (
    <div className="posts-container">
      ...
      {
        data.map((item, index) => (
            <div key={item.id} className={`post-card ${index % 2 === 0 ? 'blue' : 'yellow'}`}>
              <div className="post-header">
                <img src={userAvatar} alt="User Avatar" className="post-user-avatar" />
...
<span>اعجاب</span>
  <FaRegHeart className="post-action-icon" />
                ...
                <div className="post-action-item" onClick={() => handleCommentClick(item.id)}>
                                    <span>تعليق</span>
